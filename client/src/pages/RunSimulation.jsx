...
export default function RunSimulation() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/simulation/static_topology")
      .then((response) => {
  ...
  const handleStartSimulation = () => {
    axios
      .post("http://localhost:5000/api/simulation/trigger")
      .then((response) => {
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-row justify-between items-center mb-6">
          ...
          <button
            ...
            className="bg-btngreen hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-full flex items-center justify-center"
          >
        ...
        <div className="border border-gray-300 rounded-lg p-4 bg-white">
          <div className="relative w-full" style={{ paddingBottom: '62.5%', minHeight: '500px' }}>
